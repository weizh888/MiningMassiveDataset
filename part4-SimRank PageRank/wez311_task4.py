...
if __name__ == "__main__":
    ...
    beta = 0.8
    secondPart = r*0
    # the only non very popular element in S
    secondPart[325] = 1-beta

    linkData.cache() # to have faster computation
    for it in xrange(21): # do just 20 iterations
        print "Iteration ",it
    ...
    file = open("4.2_task4.txt",'w')
    file.write("The Top "+str(top)+" pages with highest SimRank are:\n")
    file.write("Rank  SimRank  Link\n")
    print "Rank  Node#  SimRank  Link"
    for i in xrange(top):
